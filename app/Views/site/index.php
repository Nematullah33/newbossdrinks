    ...
    <div class="shopnowbox">
        ...
        <div class="row" style="margin-top: 35px;">
            <div class="col-4 imgshow_firstcollum">
                <img src="<?php echo base_url("assets")?>/site/img/115Energy Boss - IT (13-10-2021) - Blue BG.png"
                    alt="">
                <img src="<?php echo base_url("assets")?>/site/img/115Energy Boss - IT (19-10-2021) - RED BG.png"
                    alt="">
                <img src="<?php echo base_url("assets")?>/site/img/115Energy Boss Silver Can - IT (13-10-2021).png"
                    alt="">
            ...
            <div class="col-4 imgshow_secondcollum">
                <img src="<?php echo base_url("assets")?>/site/img/115Energy Boss Sports - DE (BCAA Lemon).png" alt="">
                <img src="<?php echo base_url("assets")?>/site/img/115Energy Boss Sports - IT (BCAA Orange).png" alt="">
...
<div class="container py-5 ICONS">
    <div class="icons">
        ...
        <div class="icon_1">
            <img src="<?php echo base_url("assets")?>/site/img/icon2.png" alt="something" class="icon_class">
            <br>
            <h4 class="h4text">Sports Drink</h4>
        </div>

        <div class="icon_2">
            <img src="<?php echo base_url("assets")?>/site/img/Icon-05.png" alt="something" class="icon_class">
            <br>
        ...
        <div class="icon_3">
            <img src="<?php echo base_url("assets")?>/site/img/Icon-06.png" alt="something" class="icon_class">
            <br>
            <h4 class="h4text">Natural & Cocktail</h4>
        </div>
        <div class="icon_4">
            <img src="<?php echo base_url("assets")?>/site/img/Icon-08.png" alt="something" class="icon_class">
            <br>
        ...
        <div class="icon_5">
            <img src="<?php echo base_url("assets")?>/site/img/Icon-09.png" alt="something" class="icon_class">
            <br>
...
<div class="container product_variety">
    <div>
        <a href="<?php echo base_url("site/sport_drinks")?>/">ENERGY</a>
    </div>
    <div><a href="<?php echo base_url("site/sport/")?>">SPORT </a></div>
    <div><a href="<?php echo base_url("site/appetiser/")?>">APPETISER</a></div>
    <div><a href="<?php echo base_url("site/bcca/")?>">SPORT-BCCA </a></div>

</div>
<!-- <img src="<?php echo base_url("assets")?>/site/img/wave down.svg" alt="something" style="margin-top:-190px"> -->
<!-- <div class="MAINDIV_productdetails"></div> -->
<div class="productdetails productdetailshome row">

    <!-- first product details -->
    <div class="col-md-5 firstProductdetaisHOME" style="background: #B9B8CC;">
        <div class="img_price_class">
            <div class="imgshowclass">

                <img src="<?php echo base_url("assets")?>/site/Size_2  135x350px/Energy-Boss---IT-(13-10-2021)---Blue-BG.png"
                    alt="something" style="filter: drop-shadow(3px 4px 6px black);">
            </div>
        ...
        <div class="drinktitleclass">
            <h3 id="drinktitle" style="color: royalblue;">Energy BOSS Drink</h3>
            <!-- <p>&euro;30.36</p> -->
        </div>
    ...
    <div class="col-md-5 firstProductdetaisHOME" style="background: #ffe3af;">
        <div class="img_price_class">
            <div class="imgshowclass">

                <img src="<?php echo base_url("assets")?>/site/Size_2  135x350px/Energy-Boss-Sports---IT-(BCAA-Apple).png"
                    alt="something" style="filter: drop-shadow(3px 4px 6px black);">
            </div>
        ...
        <div class="drinktitleclass">
            <h3 id="drinktitle" style="color: darkcyan;">Energy BOSS Appetiser</h3>
            <!-- <p>&euro;30.36</p> -->
        </div>
            ...
            <div class="panel-group" id="accordion" role="tablist">
                <div class="panel">
                    <div class="panel-heading" role="tab" id="headingOne">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" href="#collapseTWO" aria-expanded="false"
                                aria-controls="collapseTWO" class="collapsed">INGREDIENTS</a>
                        </h4>
        ...
        <div class="component-accordion accordion_home" style="margin-top: 25px;">
            <div class="panel-group" id="accordion" role="tablist">
                <div class="panel">
                    <div class="panel-heading" role="tab" id="headingOne">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" href="#collapsetwo2" aria-expanded="false"
                                aria-controls="collapsetwo2" class="collapsed">NUTRATIONAL INFORMATION</a>
                        </h4>
                    </div>
                    <div id="collapsetwo2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne"
                        aria-expanded="false" style="height: 0px;" data-parent="#accordion">
                        <div class="panel-body">
                            <ul class="nutritional_INFO ">
                                <li class="row"><span class="left col-7">Serving Size:</span><span
                                        class="right col-5">Per
                                        250ml
                                        Can</span>
                                </li>
                                <li class="row"><span class="left col-7">Energy:</span><span
    ...
    <div class="col-5 firstProductdetaisHOME" style="background: #F5ACBA;;">
        <div class="img_price_class">
            ...
            <div class="imgshowclass">
                ...
                <img src="<?php echo base_url("assets")?>/site/Size_2  135x350px/Energy-Boss-Sports---DE-(BCAA-Lemon).png"
                    alt="something" style="filter: drop-shadow(3px 4px 6px black);">
            </div>
            <div class="price_class">
                <p>&euro;30.36</p>
        ...
        <div class="drinktitleclass">
            <h3 id="drinktitle" style="color: #0f900f;">Energy BOSS Appetiser</h3>
            <!-- <p>&euro;30.36</p> -->
        </div>
                    ...
                    <div class="panel-heading" role="tab" id="headingOne">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" href="#collapsethree" aria-expanded="false"
                                aria-controls="collapsethree" class="collapsed">INGREDIENTS</a>
                        </h4>
        ...
        <div class="component-accordion accordion_home" style="margin-top: 25px;">
            <div class="panel-group" id="accordion" role="tablist">
                <div class="panel">
                    <div class="panel-heading" role="tab" id="headingOne">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" href="#collapsethree2" aria-expanded="false"
                                aria-controls="collapsethree2" class="collapsed">NUTRATIONAL INFORMATION</a>
                        </h4>
                    </div>
    ...
    <div class="col-5 firstProductdetaisHOME" style="background: #ff000033; ">
        <div class="img_price_class">
            ...
            <div class="imgshowclass">
                ...
                <img src="<?php echo base_url("assets")?>/site/Size_2  135x350px/Energy-Boss---IT-(19-10-2021)---RED-BG.png"
                    alt="something" style="filter: drop-shadow(3px 4px 6px black);">
            </div>
            <div class="price_class">
                <p>&euro;30.36</p>
        ...
        <div class="drinktitleclass">
            <h3 id="drinktitle" style="color: #e22347;">Energy BOSS Drink</h3>
            <!-- <p>&euro;30.36</p> -->
        </div>
                    ...
                    <div class="panel-heading" role="tab" id="headingOne">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" href="#collapsefour" aria-expanded="false"
                                aria-controls="collapsefour" class="collapsed">INGREDIENTS</a>
                        </h4>
        ...
        <div class="component-accordion accordion_home" style="margin-top: 25px;">
            <div class="panel-group" id="accordion" role="tablist">
                <div class="panel">
                    <div class="panel-heading" role="tab" id="headingOne">
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" href="#collapsefour2" aria-expanded="false"
                                aria-controls="collapsefour2" class="collapsed">NUTRATIONAL INFORMATION</a>
                        </h4>
                    </div>
                    <div id="collapsefour2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne"
                        aria-expanded="false" style="height: 0px;" data-parent="#accordion">
                        <div class="panel-body">
                            <ul class="nutritional_INFO ">
                                <li class="row"><span class="left col-7">Serving Size:</span><span
            ...
            <div class="card card2">
                <div class="productdisplayimgBOX">
                    <a href="firstproduct.html">
                        <img src="<?php echo base_url("assets")?>/site/img/PDSEnergy Boss Original Blue.png"
                            alt="comething">
                    </a>
                </div>
            ...
            <div class="card card2">
                <div class="productdisplayimgBOX">
                    <a href="secondproduct.html">
                        <img src="<?php echo base_url("assets")?>/site/img/PDSEnergy Boss Original Red.png"
                            alt="comething">
                    </a>
                </div>
                <div class="product_display_contentbox">
            ...
            <div class="card card2">
                <div class="productdisplayimgBOX">
                    <a href="thirdproduct.html">
                        <img src="<?php echo base_url("assets")?>/site/img/PDSEnergy Boss Original Silver.png"
                            alt="comething">
                    </a>
                </div>
                <div class="product_display_contentbox">
            ...
            <div class="card card2">
                <div class="productdisplayimgBOX">
                    <a href="fourthproduct.html">
                        <img src="<?php echo base_url("assets")?>/site/img/PDSEnergy Boss Sports - IT (BCAA Apple).png"
                            alt="comething">
                    </a>
                </div>
                <div class="product_display_contentbox">
            ...
            <div class="card card2 card_5">
                <div class="productdisplayimgBOX">
                    <a href="fifthproduct.html">
                        <img src="<?php echo base_url("assets")?>/site/img/PDSEnergy Boss Sports - IT (BCAA Lemon).png"
                            alt="comething">
                    </a>
                </div>
                <div class="product_display_contentbox">
            ...
            <div class="card card2 final_card">
                <div class="productdisplayimgBOX">
                    <a href="sixthproduct.html">
                        <img src="<?php echo base_url("assets")?>/site/img/PDSEnergy Boss Sports - IT (BCAA Orange).png"
                            alt="comething">
                    </a>
                </div>
                <div class="product_display_contentbox">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <div class="secondcarousel">
                ...
                <div class="card">
                    <div class="sliderimage"><img class="d-block w-100 imageclass"
                            src="<?php echo base_url("assets")?>/site/img/Icon-07.png" alt="First slide"></div>
                    <div class="nameclass">
                        <h2>John Doe</h2>
                    </div>
