<body style="background: #F6F1E8;">
    ...
    <div class="main">
        ...
        <div class="baccadrinks_display">


            <div class="baccadrink1">
                <div class="productdisplay_imgbox">
                    <a href="fourthproduct.html">
                        <img id="can_image" src="/Size_3  193x500px/Energy-Boss-Sports---IT-(BCAA-Apple).png" alt="">
                    </a>
                </div>
            ...
            <div class="baccadrink1">
                <div class="productdisplay_imgbox" style="background: #BDBCD3;">
                    <a href="fifthproduct.html">
                        <img id="can_image" src="/Size_3  193x500px/Energy-Boss-Sports---DE-(BCAA-Lemon).png" alt="">
                    </a>
                </div>
                <div class="productidsplay_contentbox">
                    <h4>Energy BOSS Sport Lemon</h4>
                    <span class="price_productDisplay">&#163;40.<small>99</small></span>
                    <a href="fifthproduct.html" class="view_details">Veiw Details</a>

                </div>

            </div>
            <div class="baccadrink1">
                <div class="productdisplay_imgbox" style="background: #F2BFA9;">
                    <a href="sixthproduct.html">
                        <img id="can_image" src="/Size_3  193x500px/Energy-Boss-Sports---IT-(BCAA-Orange).png" alt="">
                    </a>
                </div>
                <div class="productidsplay_contentbox">
