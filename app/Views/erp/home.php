...
<head>
    ...
    <!-- waves.css -->
    <link rel="stylesheet" href="<?= base_url('assets/admin/pages/waves/css/waves.min.css')?>" type="text/css"
        media="all">
    <!-- Required Fremwork -->
    ...
    <!-- font-awesome-n -->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/admin/css/font-awesome-n.min.css')?>">
...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            <?php echo view('erp/topbar');?>

            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    <?php echo view('erp/sidebar');?>
